...
public class verify_login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Verify = findViewById(R.id.verifylogin);
        PhoneNo = findViewById(R.id.VerifyPhoneNolog);
        progressBar = findViewById(R.id.loadOTP);
        progressBar.setVisibility(View.GONE);
        nerd = findViewById(R.id.Xreceivelog);
        back = findViewById(R.id.verlogback);
    ...
    private void signInTheUserByCredentials(PhoneAuthCredential credential){
        ...
        mAuth.signInWithEmailAndPassword(Email,Password).addOnCompleteListener(verify_login.this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull @NotNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(verify_login.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
